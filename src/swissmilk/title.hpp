...
// Sourced from https://www.fide.com/docs/regulations/FIDE%20Title%20Regulations%202022.pdf
...
class SmFideTitle {
    ...
    public:
        ...
        inline SmFideTitlesEnum get_value() const {
            return this->value;
        }

        inline void set_value(SmFideTitlesEnum value) {
            this->value = value;
        }
        ...
        inline bool operator< (const SmFideTitle& rhs) const { return this->value < rhs.value; }
        inline bool operator> (const SmFideTitle& rhs) const { return this->value > rhs.value; }

        friend std::ostream& operator<<(std::ostream &out, SmFideTitle& title) {
            out << std::string("SmFideTitle { value: '") << title.to_string() << std::string("' }");
            return out;
        }

        inline SmFideTitle() {
            this->value = SmFideTitlesEnum::NoTitle;
        }

        inline SmFideTitle(SmFideTitlesEnum value) {
            this->value = value;
        }
};